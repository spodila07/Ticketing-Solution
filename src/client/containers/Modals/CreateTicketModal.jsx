        ...
        <form className={'uk-form-stacked'} onSubmit={e => this.onFormSubmit(e)}>
          ...
          <div className='uk-margin-medium-bottom'>
            <Grid>
              ...
              <GridItem width={allowAgentUserTickets ? '2-3' : '1-1'}>
                <label className={'uk-form-label'}>Customer Group</label>
                <SingleSelect
                  showTextbox={false}
                  items={mappedGroups}
          ...
          <div className='uk-margin-medium-bottom'>
            <Grid>
              ...
              <GridItem width={'2-3'}>
                <label className={'uk-form-label'}>Agent Team</label>
                <SingleSelect
                   showTextbox={false}
                   items={teams}
                   width={'100%'}
                   onSelectChange={e => {
                     this.onAgentTeamSelectChange(e)
                   }}
